...
public class AppConstants {
	...
	public static final String LOGIN_PAGE_WRONG_DATA_VALUE_MSG = "Warning: No match for E-Mail Address and/or Password";
	...
	public static final int LOGIN_PAGE_HEADERS_COUNT = 15;
	...
	public static final String PRODUCTINFO_SHEET_NAME = "product title";
