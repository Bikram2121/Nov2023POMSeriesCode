...
public class RegistrationPage {
	...
	private By registerSucessMessg = By.cssSelector("div#content h1");
	...
	public boolean registerUser(String firstName, String lastName, String email, String telephone, String password,
		...
		String successMsg = eleUtil.waitForElementVisible(registerSucessMessg, AppConstants.DEFAULT_MEDIUM_TIME_OUT)
				.getText();
